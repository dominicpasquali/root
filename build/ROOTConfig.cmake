...
set(ROOT_INCLUDE_DIRS /home/default/Repos/root/build/include)


# ROOT configured for use from the build tree - absolute paths are used.
set(ROOT_LIBRARY_DIR /home/default/Repos/root/build/lib)


# ROOT configured for use from the build tree - absolute paths are used.
set(ROOT_BINDIR /home/default/Repos/root/build/bin)


# Deprecated value, please don't use it and use ROOT_BINDIR instead.
set(ROOT_BINARY_DIR /home/default/Repos/root/build/bin)
...
set(_root_enabled_options  asimage builtin_afterimage builtin_clang builtin_gl2ps builtin_llvm builtin_lz4 builtin_lzma builtin_tbb builtin_vdt builtin_xxhash builtin_zstd clad dataframe exceptions fftw3 fitsio gdml http imt mathmore mlp mysql opengl python roofit runtime_cxxmodules shared ssl tmva tmva-cpu spectrum vdt x11 xml)
set(_root_all_options  alien arrow asimage builtin_afterimage builtin_cfitsio builtin_clang builtin_davix builtin_fftw3 builtin_freetype builtin_ftgl builtin_gl2ps builtin_glew builtin_gsl builtin_llvm builtin_lz4 builtin_lzma builtin_openssl builtin_pcre builtin_tbb builtin_unuran builtin_vc builtin_vdt builtin_veccore builtin_xrootd builtin_xxhash builtin_zlib builtin_zstd ccache cefweb clad cocoa coverage cuda cxxmodules dataframe davix dcache exceptions fftw3 fitsio fortran gdml gfal gnuinstall gsl_shared gviz http fcgi imt jemalloc libcxx macos_native mathmore memory_termination memstat mlp minuit2 monalisa mysql odbc opengl oracle pgsql pyroot_experimental pythia6_nolink pythia6 pythia8 python qt5web r roofit webgui root7 rpath runtime_cxxmodules shadowpw shared soversion sqlite ssl tcmalloc tmva tmva-cpu tmva-gpu tmva-pymva tmva-rmva spectrum unuran vc vmc vdt veccore vecgeom winrtdebug x11 xml xrootd)
