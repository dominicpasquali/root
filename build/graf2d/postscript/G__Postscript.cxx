...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TImageDump*)0x0)->GetClass(); }
   return fgIsA;
}
...
TClass *TPDF::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TPDF*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TPostScript*)0x0)->GetClass(); }
   return fgIsA;
}
...
TClass *TSVG::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TSVG*)0x0)->GetClass(); }
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TTeXDump*)0x0)->GetClass(); }
   return fgIsA;
}
...
""
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libPostscript",
        ...
        TriggerDictionaryInitialization_libPostscript_Impl, {}, classesHeaders, /*hasCxxModule*/true);
      isInitialized = true;
    }
  }
