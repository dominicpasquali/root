...
namespace ROOT {
   static TClass *ROOTcLcLExperimentalcLcLDetailcLcLRRawFile_Dictionary();
   static void ROOTcLcLExperimentalcLcLDetailcLcLRRawFile_TClassManip(TClass*);
   static void delete_ROOTcLcLExperimentalcLcLDetailcLcLRRawFile(void *p);
   static void deleteArray_ROOTcLcLExperimentalcLcLDetailcLcLRRawFile(void *p);
   static void destruct_ROOTcLcLExperimentalcLcLDetailcLcLRRawFile(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ROOT::Experimental::Detail::RRawFile*)
   {
      ::ROOT::Experimental::Detail::RRawFile *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::ROOT::Experimental::Detail::RRawFile));
      static ::ROOT::TGenericClassInfo 
         instance("ROOT::Experimental::Detail::RRawFile", "ROOT/RRawFile.hxx", 43,
                  typeid(::ROOT::Experimental::Detail::RRawFile), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &ROOTcLcLExperimentalcLcLDetailcLcLRRawFile_Dictionary, isa_proxy, 4,
                  sizeof(::ROOT::Experimental::Detail::RRawFile) );
      instance.SetDelete(&delete_ROOTcLcLExperimentalcLcLDetailcLcLRRawFile);
      instance.SetDeleteArray(&deleteArray_ROOTcLcLExperimentalcLcLDetailcLcLRRawFile);
      instance.SetDestructor(&destruct_ROOTcLcLExperimentalcLcLDetailcLcLRRawFile);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::ROOT::Experimental::Detail::RRawFile*)
   {
      return GenerateInitInstanceLocal((::ROOT::Experimental::Detail::RRawFile*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::ROOT::Experimental::Detail::RRawFile*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *ROOTcLcLExperimentalcLcLDetailcLcLRRawFile_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::ROOT::Experimental::Detail::RRawFile*)0x0)->GetClass();
      ROOTcLcLExperimentalcLcLDetailcLcLRRawFile_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TFile*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TFile", ::TFile::Class_Version(), "TFile.h", 48,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TStreamerInfoActions::TConfiguration*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TStreamerInfoActions::TConfiguration", "TStreamerInfoActions.h", 30,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TStreamerInfoActions::TConfiguredAction*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TStreamerInfoActions::TConfiguredAction", ::TStreamerInfoActions::TConfiguredAction::Class_Version(), "TStreamerInfoActions.h", 75,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TStreamerInfoActions::TActionSequence*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TStreamerInfoActions::TActionSequence", ::TStreamerInfoActions::TActionSequence::Class_Version(), "TStreamerInfoActions.h", 173,
...
namespace ROOT {
   ...
   static void delete_ROOTcLcLExperimentalcLcLDetailcLcLRRawFile(void *p) {
      delete ((::ROOT::Experimental::Detail::RRawFile*)p);
   }
   static void deleteArray_ROOTcLcLExperimentalcLcLDetailcLcLRRawFile(void *p) {
      delete [] ((::ROOT::Experimental::Detail::RRawFile*)p);
   }
   static void destruct_ROOTcLcLExperimentalcLcLDetailcLcLRRawFile(void *p) {
      typedef ::ROOT::Experimental::Detail::RRawFile current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::ROOT::Experimental::Detail::RRawFile
