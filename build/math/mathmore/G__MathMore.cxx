...
namespace ROOT {
   static TClass *ROOTcLcLMathcLcLGSLQuasiRandomEngine_Dictionary();
   static void ROOTcLcLMathcLcLGSLQuasiRandomEngine_TClassManip(TClass*);
   static void *new_ROOTcLcLMathcLcLGSLQuasiRandomEngine(void *p = 0);
   static void *newArray_ROOTcLcLMathcLcLGSLQuasiRandomEngine(Long_t size, void *p);
   static void delete_ROOTcLcLMathcLcLGSLQuasiRandomEngine(void *p);
   static void deleteArray_ROOTcLcLMathcLcLGSLQuasiRandomEngine(void *p);
   static void destruct_ROOTcLcLMathcLcLGSLQuasiRandomEngine(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ROOT::Math::GSLQuasiRandomEngine*)
   {
      ::ROOT::Math::GSLQuasiRandomEngine *ptr = 0;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::ROOT::Math::GSLQuasiRandomEngine));
      static ::ROOT::TGenericClassInfo 
         instance("ROOT::Math::GSLQuasiRandomEngine", "Math/GSLQuasiRandom.h", 52,
                  typeid(::ROOT::Math::GSLQuasiRandomEngine), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &ROOTcLcLMathcLcLGSLQuasiRandomEngine_Dictionary, isa_proxy, 4,
                  sizeof(::ROOT::Math::GSLQuasiRandomEngine) );
      instance.SetNew(&new_ROOTcLcLMathcLcLGSLQuasiRandomEngine);
      instance.SetNewArray(&newArray_ROOTcLcLMathcLcLGSLQuasiRandomEngine);
      instance.SetDelete(&delete_ROOTcLcLMathcLcLGSLQuasiRandomEngine);
      instance.SetDeleteArray(&deleteArray_ROOTcLcLMathcLcLGSLQuasiRandomEngine);
      instance.SetDestructor(&destruct_ROOTcLcLMathcLcLGSLQuasiRandomEngine);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::ROOT::Math::GSLQuasiRandomEngine*)
   {
      return GenerateInitInstanceLocal((::ROOT::Math::GSLQuasiRandomEngine*)0);
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const ::ROOT::Math::GSLQuasiRandomEngine*)0x0); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *ROOTcLcLMathcLcLGSLQuasiRandomEngine_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const ::ROOT::Math::GSLQuasiRandomEngine*)0x0)->GetClass();
      ROOTcLcLMathcLcLGSLQuasiRandomEngine_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_ROOTcLcLMathcLcLGSLQuasiRandomEngine(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::ROOT::Math::GSLQuasiRandomEngine : new ::ROOT::Math::GSLQuasiRandomEngine;
   }
   static void *newArray_ROOTcLcLMathcLcLGSLQuasiRandomEngine(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) ::ROOT::Math::GSLQuasiRandomEngine[nElements] : new ::ROOT::Math::GSLQuasiRandomEngine[nElements];
   }
   // Wrapper around operator delete
   static void delete_ROOTcLcLMathcLcLGSLQuasiRandomEngine(void *p) {
      delete ((::ROOT::Math::GSLQuasiRandomEngine*)p);
   }
   static void deleteArray_ROOTcLcLMathcLcLGSLQuasiRandomEngine(void *p) {
      delete [] ((::ROOT::Math::GSLQuasiRandomEngine*)p);
   }
   static void destruct_ROOTcLcLMathcLcLGSLQuasiRandomEngine(void *p) {
      typedef ::ROOT::Math::GSLQuasiRandomEngine current_t;
      ((current_t*)p)->~current_t();
   }
} // end of namespace ROOT for class ::ROOT::Math::GSLQuasiRandomEngine
...
""
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("libMathMore",
        ...
        TriggerDictionaryInitialization_libMathMore_Impl, {}, classesHeaders, /*hasCxxModule*/true);
      isInitialized = true;
    }
  }
